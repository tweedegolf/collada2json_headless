...
const parseCollada = (i) => {
  ...
  // Parse the XML of the Collada and find all the images that are
  // used in textures.
  ...
  // Parse the Collada into a Threejs model, then we traverse the model to find materials with
  // textures; we add a key 'map' to the material if that material uses a texture
